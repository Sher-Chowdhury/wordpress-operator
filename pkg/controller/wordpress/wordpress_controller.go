...
import (
	...
	cachev1alpha1 "github.com/codingbee/my-wordpress-operator/pkg/apis/cache/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &cachev1alpha1.Wordpress{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileWordpress) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &cachev1alpha1.Wordpress{}
...
func newPodForCR(cr *cachev1alpha1.Wordpress) *corev1.Pod {
