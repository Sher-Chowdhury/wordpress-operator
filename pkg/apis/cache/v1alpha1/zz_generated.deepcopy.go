...
func (in *Imageinfodetails) DeepCopyInto(out *Imageinfodetails) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Imageinfodetails.
func (in *Imageinfodetails) DeepCopy() *Imageinfodetails {
	if in == nil {
		return nil
	}
	out := new(Imageinfodetails)
	in.DeepCopyInto(out)
	return out
}
